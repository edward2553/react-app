      ...
      <Router>
        <div className="main-layout">
          ...
          <Switch>
            <Route exact path="/">
              <ul>
                <li onClick={() => window.location.replace('/register')}>Custom Form</li>
                <li onClick={() => window.location.replace('/formik-basic')}>Formik basic</li>
                <li onClick={() => window.location.replace('/formik-yup')}>Formik yup</li>
                <li onClick={() => window.location.replace('/formik-components')}>Formik Components</li>
                <li onClick={() => window.location.replace('/formik-abstract')}>Formik Abstract</li>
              </ul>
            </Route>
